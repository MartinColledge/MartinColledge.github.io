...
<style>
    .researchgate-icon, .scholar-icon, .orcid-icon, .github-icon {
        display: inline-block;
        transition: transform 0.2s, opacity 0.2s;
    }
    .researchgate-icon:hover, .scholar-icon:hover, .orcid-icon:hover , .github-icon:hover {
        transform: scale(1.1);
        opacity: 0.8;
    }
</style>
